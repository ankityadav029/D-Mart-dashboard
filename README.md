# D-Mart-Dashboard in Lookerstudio
...
* **Sales by Region** to identify high-performing markets
* **Quantity by Ship Mode** to analyze delivery preferences

### Trend Analysis

* **Sales Over Time** visualization to track growth and seasonal patterns
...
* City filter
* Date range selector
* Sales and discount range filters
...
* Sales trends show consistent growth over time with seasonal fluctuations.
* Filtering by region and city helps identify local market performance.
